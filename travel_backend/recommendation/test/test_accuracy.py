...
from recommendation.accuracy_checker import (
    AccuracyMetrics,
    SystemAccuracyEvaluator,
)
...
class AccuracyMetricsTest(TestCase):
    ...
    def test_dcg_calculation(self):
        ...
        dcg = AccuracyMetrics.calculate_dcg(
            scores,
            k=5
        )
    ...
    def test_mrr_first_position(self):
        ...
        mrr = AccuracyMetrics.calculate_mrr(
            recommendations,
            relevant_items
        )
...
class SystemAccuracyEvaluatorTest(TestCase):
    ...
    def setUp(self):
        ...
        #
        # TravelPackage.start_location requires a StartLocation,
        # NOT a Destination.
        # ---------------------------------------------------------

        self.start1 = StartLocation.objects.create(
            pName="Kathmandu",
            province="Bagmati",
            latitude=27.7172,
            longitude=85.3240,
        ...
        self.start2 = StartLocation.objects.create(
            pName="Pokhara",
            province="Gandaki",
            latitude=28.2096,
            longitude=83.9856,
        ...
        #
        # Actual TravelPackage model uses:
        #   name
    ...
    def test_single_user_evaluation(self):
        ...
        self.assertIn(
            "destination_precision_5",
            result
        )

        self.assertIn(
            "destination_recall_5",
            result
        )
...
class RecommendationAccuracyIntegrationTest(TestCase):
    ...
    def setUp(self):
        ...
        #
        # TravelPackage.start_location requires StartLocation.
        # ---------------------------------------------------------

        self.start_location = StartLocation.objects.create(
            pName="Test Start",
            province="Test",
            latitude=27.7172,
            longitude=85.3240,
    ...
    def test_recommendation_returns_valid_results(self):
        ...
        destinations = response.data.get(
            "destination_results",
            []
        )
